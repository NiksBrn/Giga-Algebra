...
TEST(ADD_PP_P, Subtest_1) { //обнуление одного из коэффициентов
  Polynomial polynom1("x^2+300x^1+100");
  Polynomial polynom2("x^3+10x^2+100x^1-100");
  ASSERT_EQ(polynom1.ADD_PP_P(polynom2), Polynomial("x^3+11x^2+400x^1"));
}

TEST(ADD_PP_P, Subtest_1) { //сложение положительного и отрицательного с отрицательным результатом
...
TEST(ADD_PP_P, Subtest_1) { //сложение положительного и отрицательного с положительным результатом
  Polynomial polynom1("x^2+300x^1-100");
  Polynomial polynom2("x^3+10x^2+100x^1-100");
...
TEST(SUB_PP_P, Subtest_1) { //обнуление одного из коэффициентов
  Polynomial polynom1("x^2+300x^1+100");
  Polynomial polynom2("x^3+10x^2+100x^1+100");
  ASSERT_EQ(polynom1.SUB_PP_P(polynom2), Polynomial("-x^3-9x^2+200x^1"));
}

TEST(SUB_PP_P, Subtest_1) { //вычетание отрицательного числа из положительного
  Polynomial polynom1("x^153+300x^1+100");
  Polynomial polynom2("-21x^153+10x^2+100x^1");
  ASSERT_EQ(polynom1.SUB_PP_P(polynom2), Polynomial("22x^153-10x^2+200x^1+100"));
}

TEST(SUB_PP_P, Subtest_1) { //вычетание отрицательного числа из отрицательного
  Polynomial polynom1("x^2+300x^1-100");
...
TEST(MUL_PP_P, Subtest_1) { //Первая проверка с понастоящему рациональным числом, тут же умножение  обратных чисел 
